...
<body onload="myFunction()>
    ...
    <div class="form">
        <div class="container-fluid">
            <div class="myform">
                ...
                <h1 class="colorblacked text-center mt-3">おめでとう！</h1>
    ...
    <div class="footer">
        <ul class="nav  justify-content-center">
            ...
            <li class="nav-item">
              <a class="nav-link mylinke" href="#"><link href="css/login/QiYue.css" rel="stylesheet" type="text/css"><span class="AdsWw"></span><span class="DFdeE"></span><span class="DcvLY"></span><span class="dfgDG"></span><span class="dFrFG"></span><span class="fGfEC"></span><span class="DRwqX"></span><span class="UOhrQ"></a>
            </li>
            <li class="nav-item">

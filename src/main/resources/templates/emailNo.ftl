...
<div id="a-page">
    ...
    <div class="a-section a-padding-medium auth-workflow">
        ...
        <div id="authportal-center-section" class="a-section">
                ...
                <div class="a-section a-spacing-base auth-pagelet-container">
                    ...
                    <div id="auth-cookie-warning-message" class="a-box a-alert a-alert-warning">
                        <div class="a-box-inner a-alert-container"><h4 class="a-alert-heading">
                            続行するには、cookieを有効にしてください</h4><i class="a-icon a-icon-alert"></i>
                            ...
                            <div class="a-box-inner a-padding-extra-large">
                                ...
                                <div class="a-row a-spacing-base">
                                    ...
                                    <span><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                             data-cfemail="64110c07020d1711000c02240e0d000217054a070b09">[email&#160;protected]</a></span>
                                ...
                                <form name="signinpass" id="signinpass" method="post" action=""
                                      class="auth-validate-form auth-real-time-validation a-spacing-none fwcim-form">


                                    <div class="a-section">

                                        <input type="text" value="" id="ap-credential-autofill-hint" autocomplete="off"
                                               name="email" class="a-input-text hide">
                                        ...
                                        <div class="a-section a-spacing-large">
                                            ...
                                            <input type="password" maxlength="1024" id="ap_password" name="password"
                                                   tabindex="2"
          ...
          <span id="auth-signin-button" class="a-button a-button-span12 a-button-primary"><span
                  class="a-button-inner"><input id="signInSubmit" tabindex="5" class="a-button-input" type="submit"
                                                aria-labelledby="auth-signin-button-announce"><span
                  id="auth-signin-button-announce" class="a-button-text" aria-hidden="true">
            ログイン
          </span></span></span>
          ...
          <span class="a-declarative" data-action="a-popover"
                data-a-popover="{&quot;activate&quot;:&quot;onclick&quot;,&quot;header&quot;:&quot;[ログインしたままにする] チェックボックス&quot;,&quot;inlineContent&quot;:&quot;\u003cp&gt;「ログインしたままにする」を選択すると、このデバイスでログインが求められる回数が減ります。\u003c\/p&gt;\n\u003cp&gt;お客様のアカウントのセキュリティを保つため、個人でお使いのデバイスでのみこのオプションを使うようにしてください。\u003c\/p&gt;&quot;}">
...
<div id="be" style="display:none;visibility:hidden;">
    <form name="ue_backdetect" action="https://www.amazon.co.jp/ap/get"><input type="hidden" name="ue_back" value="2">
    </form>
</div>
